        ...
        <?php while(have_rows('social', 'option')) : the_row(); ?>
            <li>
                ...
                <?php if(get_sub_field('network') == 'instagram') : ?>
                    <a href="<?php echo $link['url']; ?>" target="_blank">
                    <span class="visually-hidden">Instagram</span><i
                ...
                <?php if(get_sub_field('network') == 'vimeo') : ?>
                    <a href="<?php echo $link['url']; ?>" target="_blank">
                    <span class="visually-hidden">Vimeo</span><i
                        class="social-icon fab fa-vimeo-v"
                        aria-hidden="true"
                    ></i
                ></a>
                <?php endif; ?>
                ...
                <?php if(get_sub_field('network') == 'email') : ?>
                    <a href="<?php echo $link['url']; ?>" target="_blank">
                    <span class="visually-hidden">Email</span><i
                        class="social-icon far fa-paper-plane"
                        aria-hidden="true"
                    ></i
                ></a>
                <?php endif; ?>
